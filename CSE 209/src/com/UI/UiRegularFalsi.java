...
import com.Numerical.RegularFalsi;

public class UiRegularFalsi
{
	...
	public UiRegularFalsi()
	{
		frame=new JFrame("Regular Falsi");
		panel=new JPanel();
		...
		b1.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				try 
				{
					...
					RegularFalsi B=new RegularFalsi();
					String ans=B.Gen(g1,g2,g3);
					Show S=new Show(ans, "Regular");
				} 
